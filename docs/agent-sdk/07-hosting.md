...
See [SandboxSettings](https://platform.claude.com/docs/en/agent-sdk/typescript#sandboxsettings) in the TypeScript SDK reference for the full configuration options.
...
- [TypeScript SDK - Sandbox Settings](https://platform.claude.com/docs/en/agent-sdk/typescript#sandboxsettings) - Configure sandbox programmatically
